...
mkdir -p "workspace_new/docs/docs/4. Flamingo Commerce/3. Adapter/1. Standalone/csvcommerce"
mkdir -p "workspace_new/docs/docs/4. Flamingo Commerce/3. Adapter/1. Standalone/productSearch"
...
cp -R  "workspace_new/flamingo-commerce-adapter-standalone/csvcommerce/Readme.md" "workspace_new/docs/docs/4. Flamingo Commerce/3. Adapter/1. Standalone/csvcommerce/"
cp -R  "workspace_new/flamingo-commerce-adapter-standalone/productSearch/Readme.md" "workspace_new/docs/docs/4. Flamingo Commerce/3. Adapter/1. Standalone/productSearch/"
...
cp -R "workspace_new/example-flamingo-carotene/docs/" "workspace_new/docs/docs/5. Template Engine Flamingo Carotene/1. Introduction/docs/"
...
cp -R "workspace_new/example-flamingo-carotene/docs/" "workspace_new/docs/docs/6. Trainings/docs/"
