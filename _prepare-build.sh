...
cp -R -L "workspace/flamingo/docs/2. Framework Modules" "workspace/docs/docs/1. Flamingo Core/"
cp -R -L "workspace/flamingo/docs/3. Core Modules" "workspace/docs/docs/1. Flamingo Core/"
cp -R "workspace/flamingo/docs/4. Others" "workspace/docs/docs/1. Flamingo Core/"
